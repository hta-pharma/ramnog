...
#> ✔ fn_map_tibble completed [4ms, 8.30 kB]
#> + ep_and_data declared [1 branches]
#> ✔ ep_and_data completed [15ms, 29.26 kB]
#> + fn_map declared [1 branches]
#> ✔ fn_map completed [1ms, 8.28 kB]
...
#> ✔ ep_prep_by_strata_across_trt completed [57ms, 9.88 kB]
#> + ep_prep_across_strata_across_trt declared [1 branches]
#> ✔ ep_prep_across_strata_across_trt completed [20ms, 7.56 kB]
#> + ep_prep_by_strata_by_trt declared [1 branches]
#> ✔ ep_prep_by_strata_by_trt completed [87ms, 10.06 kB]
#> + ep_rejected dispatched
#> ✔ ep_rejected completed [0ms, 412 B]
#> + ep_stat_by_strata_across_trt declared [1 branches]
#> ✔ ep_stat_by_strata_across_trt completed [135ms, 2.93 kB]
#> + ep_stat_across_strata_across_trt declared [1 branches]
#> ✔ ep_stat_across_strata_across_trt completed [38ms, 2.17 kB]
#> + ep_stat_by_strata_by_trt declared [1 branches]
#> ✔ ep_stat_by_strata_by_trt completed [57ms, 3.38 kB]
#> + ep_stat_nested dispatched
#> ✔ ep_stat_nested completed [1ms, 4.55 kB]
#> + ep_stat dispatched
#> ✔ ep_stat completed [13ms, 5.08 kB]
#> ✔ ended pipeline [1.3s, 24 completed, 0 skipped]
