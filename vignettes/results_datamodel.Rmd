...
<tbody>
  ...
  <tr>
    <td rowspan="5">Level 6: Statistics</td>
  ...
  <tr>
    <td>`stat_result_method`</td>
    <td>char</td>
    <td>Algorithm or test used to produce the statistic; NA when no runtime method choice was made.</td>
  </tr>
</tbody>
</table>
