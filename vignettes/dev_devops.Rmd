...
Git Actions are a set of automated workflows that are automatically triggered on specific events in a repository.
...
<details>
<summary>Error: Python not available </summary>
